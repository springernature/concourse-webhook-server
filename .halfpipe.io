...
- type: deploy-cf
  ...
  vars:
    ...
    CONCOURSE_DB_HOST: ((halfpipe-concourse-db-pg13-prod.host))
    CONCOURSE_DB_USERNAME: ((halfpipe-concourse-db-pg13-prod.username_read))
    CONCOURSE_DB_PASSWORD: ((halfpipe-concourse-db-pg13-prod.password_read))
